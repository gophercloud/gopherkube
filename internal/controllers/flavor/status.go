...
type applyConfigConstructorT = generic.ORCApplyConfigConstructor[*objectApplyT, *statusApplyT]

var _ generic.ResourceStatusWriter[*orcv1alpha1.Flavor, *flavors.Flavor, *objectApplyT, *statusApplyT] = flavorStatusWriter{}

func (flavorStatusWriter) GetApplyConfigConstructor() applyConfigConstructorT {
